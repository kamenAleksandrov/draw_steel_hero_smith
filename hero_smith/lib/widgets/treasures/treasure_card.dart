...
class _TreasureCardState extends State<TreasureCard>
  ...
  Color _getLevelColor(int level) {
    switch (level) {
      ...
      case 5: return const Color(0xFF2196F3);
      case 9: return const Color(0xFF9C27B0);
      default: return Colors.grey;
    }
  }
  ...
  Widget _buildCraftingSection(
    ...
    final projectGoalDescription = widget.component.data['project_goal_description'] as String?;
    final projectRollCharacteristics = widget.component.data['project_roll_characteristics'];
    
    final hasContent = (prerequisite != null && prerequisite.isNotEmpty && prerequisite.toLowerCase() != 'unknown') ||
                      projectSource != null || 
                      projectGoal != null;
    ...
    if (prerequisite != null && prerequisite.isNotEmpty && prerequisite.toLowerCase() != 'unknown') {
